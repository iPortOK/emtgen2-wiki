import { createStats, createImage, createEquipmentItem, } from './funkce.js';
  ...
  export const stityData = [
    createEquipmentItem(10,'Pětihranný štít', './items/13020.png', 'Silný divoký pěšák', {
      ...
      createEquipmentItem(10,'Štít třech císařů', './items/Štít třech císařů.png', 'Překovem z Titánský štít', { // last changed 03/02/2025
        ...
        RADEK_3: createStats("Průměrná odolnost proti škoda:", "10%", "11%", "11%", "11%", "12%", "12%", "12%", "13%", "14%", "15%"),
        RADEK_4: createStats("Odolnost proti poškození schopností:", "5%", "6%", "6%", "6%", "7%", "7%", "7%", "8%", "9%", "10%"),
      ...
      createEquipmentItem(10,'Štít prokletí', './items/13210.png', 'Překovem z Štít třech císařů', { // last changed 03/02/2025
        ...
        RADEK_2: createStats("Silný proti bossům:", "16%", "16%", "16%", "16%", "17%", "17%", "17%", "18%", "21%", "30%"),
        RADEK_3: createStats("Průměrná odolnost proti škoda:", "15%", "15%", "15%", "16%", "16%", "16%", "17%", "18%", "19%", "20%"),
        RADEK_4: createStats("Odolnost proti poškození schopností:", "10%", "11%", "11%", "11%", "12%", "12%", "12%", "13%", "14%", "15%"),
        RADEK_5: createStats("Hodnota útoku:", "+85", "+90", "+95", "+100", "+105", "+110", "+115", "+120", "+135", "+160"),
        MEZERA_X: createStats("", "", "", "", "", "", "", "", "", "", ""),
        ...
        IMG_7: createImage("", "", "", "", "", "", "", "", "", "", ""),
        MEZERA_Y: createStats("", "", "", "", "", "", "", "", "", "", ""),
        IMG_8: createImage("", "./items/Štít třech císařů.png", "./items/Runa IV.png", "./items/Runa IV.png", "./items/Runa IV.png", "./items/Runa IV.png", "./items/Runa IV.png", "./items/Runa IV.png", "./items/Runa IV.png", "./items/Runa IV.png", "./items/Runa IV.png"),
      ...
      createEquipmentItem(10,'Štít Zarytosti', './items/11976.png', 'Překovem z Štítu prokletí', { // last changed 03/02/2025
        ...
        RADEK_4: createStats("Odolnost proti poš. schopností:", "15%", "16%", "16%", "16%", "16%", "17%", "17%", "18%", "19%", "20%"),
    ...
    createEquipmentItem(10,'Hadí štít', './items/hadi_gear/Hadí štít.png', 'Překov z Štítu Zarytosti', { // last changed February 26th, 2025
  ...
  createEquipmentItem(10, "Smaragdový štít", "./items/Smaragdový štít.png", "Překov z Štítu Zarytosti", {
    RADEK_0: createStats("Od úrovně:", 120, 120, 120, 120, 120, 120, 120, 120, 120, 120),
    RADEK_XX: createStats("", "", "", "", "", "", "", "", "", "", ""),
    RADEK_1: createStats("Hodnota útoku", "+250", "+255", "+260", "+265", "+270", "+275", "+280", "+290", "+300", "+320"),
    RADEK_2: createStats("Max. ZB", "+1000", "+1500", "+2000", "+2500", "+3000", "+4000", "+5000", "+6000", "+8000", "+10000"),
    RADEK_3: createStats("Odolnost proti poš. schopností", "20%", "20%", "21%", "21%", "21%", "22%", "22%", "23%", "24%", "25%"),
    RADEK_4: createStats("Průměrná odolnost proti škodě", "25%", "25%", "25%", "25%", "25%", "25%", "25%", "25%", "25%", "25%"),
    MEZERA_X: createStats("", "", "", "", "", "", "", "", "", "", ""),

import { createStats, createImage, createEquipmentItem } from './funkce.js';
  ...
  export const nahrdelnikData = [
    ...
    createEquipmentItem(10,'Náhrdelník krystalu duše', './items/16220.png', 'Azrael', {
      ...
      createEquipmentItem(10,'Náhrdelník Kouř. nefritu', './items/Náhrdelník Kouř. nefritu.png', 'Překov z Náhrdelníku krystalu duše', { // last edited 04/03/2025
      ...
      createEquipmentItem(10,'Náhrdelník Temn. nefritu', './items/16600.png', 'Překov z Náhrdelníku Kouř. nefritu', { // last edited 04/03/2025
        ...
        IMG_6: createImage("", "", "", "", "", "", "", "", "", "", ""),
        MEZERA_Y: createStats(),
        IMG_7: createImage("", "./items/Náhrdelník Kouř. nefritu.png", "./items/Runa IV.png", "./items/Runa IV.png", "./items/Runa IV.png", "./items/Runa IV.png", "./items/Runa IV.png", "./items/Runa IV.png", "./items/Runa IV.png", "./items/Runa IV.png", "./items/Runa IV.png"),
  ...
  createEquipmentItem(10, "Smaragdový náhrdelník", "./items/Smaragdový náhrdelník.png", "Překov z Safírového náhrdelníku", {
    RADEK_0: createStats("Od úrovně:", 120, 120, 120, 120, 120, 120, 120, 120, 120, 120),
    RADEK_XX: createStats("", "", "", "", "", "", "", "", "", "", ""),
    RADEK_1: createStats("Poškození schopnost", "9%", "9%", "9%", "9%", "10%", "10%", "10%", "11%", "11%", "12%"),
    RADEK_2: createStats("Rychlost kouzel", "31%", "31%", "32%", "32%", "33%", "34%", "35%", "36%", "38%", "40%"),
    RADEK_3: createStats("Silný proti ninjům", "21%", "21%", "22%", "22%", "23%", "24%", "25%", "26%", "28%", "30%"),
    RADEK_4: createStats("Silný proti šamanům", "21%", "21%", "22%", "22%", "23%", "24%", "25%", "26%", "28%", "30%"),
    MEZERA_X: createStats("", "", "", "", "", "", "", "", "", "", ""),

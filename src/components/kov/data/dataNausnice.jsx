import { createStats, createImage, createEquipmentItem } from './funkce.js';
  ...
  export const nausniceData = [
    ...
    createEquipmentItem(10,'Náušnice krystalu duše', './items/17220.png', 'Azrael', {
      ...
      createEquipmentItem(10,'Náušnice Kouř. nefritu', './items/Náušnice Kouř. nefritu.png', 'Překov z Náušnic krystalu duše', {
      ...
      createEquipmentItem(10,'Náušnice Temn. nefritu', './items/17590.png', 'Překov z Náušnic Kouř. nefritu', { // last updated 04/03/2025
        ...
        IMG_6: createImage("", "", "", "", "", "", "", "", "", "", ""),
        MEZERA_Y: createStats(),
        IMG_7: createImage("", "./items/Náušnice Kouř. nefritu.png", "./items/Runa IV.png", "./items/Runa IV.png", "./items/Runa IV.png", "./items/Runa IV.png", "./items/Runa IV.png", "./items/Runa IV.png", "./items/Runa IV.png", "./items/Runa IV.png", "./items/Runa IV.png"),
    ...
    createEquipmentItem(10,'Hadí náušnice', './items/hadi_gear/Hadí náušnice.png', 'Překov z Náušnic Slun. nefritu', {
      ...
      RADEK_XX: createStats("", "", "", "", "", "", "", "", "", "", ""),
      RADEK_1: createStats("VIT, INT, SIL, POH", "+31", "+31", "+31", "+31", "+32", "+32", "+32", "+33", "+34", "+35"),
      RADEK_2: createStats("Silný proti příšerám:", "+51%", "+52%", "+53%", "+54%", "+55%", "+56%", "+58%", "+61%", "+65%", "+70%"),
  ...
  createEquipmentItem(10, "Smaragdové náušnice", "./items/Smaragdové náušnice.png", "Překov z Safírových náušnic", {
    RADEK_0: createStats("Od úrovně:", 120, 120, 120, 120, 120, 120, 120, 120, 120, 120),
    RADEK_XX: createStats("", "", "", "", "", "", "", "", "", "", ""),
    RADEK_1: createStats("Max. ZB", "+11000", "+11250", "+11500", "+11750", "+12000", "+12250", "+12750", "+13250", "+14000", "+15000"),
    RADEK_2: createStats("Odolnost proti lidem", "17%", "17%", "18%", "18%", "19%", "19%", "21%", "22%", "23%", "25%"),
    RADEK_3: createStats("Průměrná odolnost proti škoda", "8%", "8%", "8%", "8%", "9%", "9%", "9%", "10%", "11%", "12%"),
    RADEK_4: createStats("VIT,INT,SIL,POH", "26%", "26%", "26%", "26%", "27%", "27%", "27%", "28%", "29%", "30%"),    
    MEZERA_X: createStats("", "", "", "", "", "", "", "", "", "", ""),
